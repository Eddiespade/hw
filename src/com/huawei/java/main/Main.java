...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((curDemand = ReadDemandFile.read()) != null) {
            ...
            if (percentFive > 0) {
                curAssignment = maxPlan(curDemand);
                percentFive--;
            } else {
                curAssignment = averagePlan(curDemand);
            }
            // // 写入到输出文件中
    ...
    private static String[] maxPlan(Demand curDemand) {
        // 利用5%疯狂使用
        // 创建分配方案
        ...
        while (!custom.isEmpty()) {
            ...
            // 平均分配的话，每个边缘节点需要的带宽
            int average = (needBandWidth * 5) / siteCount + 1;
            // 开始分配
